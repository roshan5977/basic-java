...
public class Test300 {
	...
	public static void main(String[] args) {
           ...
           if (choice==1) {
        	   ...
        	   int one=sc.nextInt();
        	   System.out.println(one+" is of length= "+Firstcode.len(one));
        	  
		}
           if (choice==2) {
        	   System.out.println("BOSS ENTER THE NUM I WANNA DO SUM THE DIGITS");
        	   int two=sc.nextInt();
        	   System.out.println("BOSS sum of digits in "+ two+" is "+Firstcode.sum(two));
        	 
		}
           if (choice==3) {
        	   System.out.println("BOSS ENTER THE NUM I WANNA FIND FACTORIAL");
        	   int three=sc.nextInt();
        	   System.out.println("BOSS Factorial of "+three+"is "+Firstcode.factorial(three));
           ...
           if (choice==7) {
        	   ...
        	   Firstcode.primerange(seven,seven_);
           ...
           if (choice==8) {
        	   ...
        	   Firstcode.armstrongrange(eight,eight_);
        	  
		}
           if (choice==9) {
        	   System.out.println("BOSS ENTER THE NUM I WANNA FIND PERFECT NUM");
        	   int nine=sc.nextInt();
        	   System.out.println(nine+"is of length= "+Firstcode.len(nine));
        	  
		}
           if (choice==10) {
        	   System.out.println("BOSS ENTER THE NUM I WANNA COUNT");
        	   int ten=sc.nextInt();
        	   System.out.println(ten+"is of length= "+Firstcode.len(ten));
           ...
           if (choice==15) {
        	   ...
        	   Firstcode.fib_range(fifteen,fifteen_);
		}
           if (choice==16) {
        	   ...
        	   System.out.println("The lcm for "+sixteen+" and "+sixteen_+" is "+Firstcode.lcm(sixteen,sixteen_));
